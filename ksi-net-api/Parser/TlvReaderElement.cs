...
namespace Guardtime.KSI.Parser
{
    ...
    /// </summary>
    public class TlvReaderElement : BinaryReader
    {
        ...
        public TlvReaderElement(Stream input) : base(input)
        {
        }
        ...
        public TlvReaderElement(Stream input, Encoding encoding) : base(input, encoding)
        {
        }
        ...
        public TlvElement ReadTag() {
            try {
                ...
                return new TlvElement(type, nonCritical, forward, new TlvBinary(data));
