...
namespace Guardtime.KSI.Test.Integration
{
    ...
    public class BlockSignerTests : IntegrationTests
    {
        ...
        public void BlockSignerTreeHeightLimitTest(Ksi ksi)
        {
            ...
            {
                new HeightTestData(new List<uint> { 1 }, null, 1, 0),
                new HeightTestData(new List<uint> { 1, 2, 1 }, null, 4, 2),
                new HeightTestData(new List<uint> { 1, 2, 2 }, null, 4, 2),
                new HeightTestData(new List<uint> { 1, 0, 1 }, null, 3, 2),
                new HeightTestData(new List<uint> { 0, 0, 0 }, new List<bool> { true, false, true }, 3, 2),
                new HeightTestData(new List<uint> { 2, 1, 1, 1 }, null, 4, 3),
                new HeightTestData(new List<uint> { 1, 0, 0, 0 }, null, 3, 3),
                new HeightTestData(new List<uint> { 0, 0, 0, 0, 0 }, new List<bool> { true, true, true, true, true }, 4, 4),
                new HeightTestData(new List<uint> { 1, 0, 1, 0, 0, 0 }, null, 4, 5),
                new HeightTestData(new List<uint> { 0, 0, 0, 1, 0, 1, 0 }, null, 4, 5),
                new HeightTestData(new List<uint> { 0, 0, 0, 0, 0, 0 }, new List<bool> { true, false, true, false, false, false }, 4, 5),
                new HeightTestData(new List<uint> { 0, 0, 0, 0, 0, 0, 0, 0, 0 }, new List<bool> { false, false, false, false, false, false, false, false, false }, 4, 8),
                new HeightTestData(new List<uint> { 3, 3 }, new List<bool> { false, false }, 4, 1),
                new HeightTestData(new List<uint> { 3, 3 }, new List<bool> { true, true }, 4, 0),
                new HeightTestData(new List<uint> { 0, 3 }, new List<bool> { false, false }, 4, 1),
                new HeightTestData(new List<uint> { 3, 0 }, new List<bool> { false, false }, 4, 1),
                new HeightTestData(new List<uint> { 2, 0, 0, 0, 0, 0 }, null, 4, 5),
                new HeightTestData(new List<uint> { 4, 3, 2, 3, 1, 0, 3, 2, 0, 3 }, null, 7, 9),
                new HeightTestData(new List<uint> { 4, 3, 2, 3, 1, 0, 3, 2, 0, 1, 0, 0 }, null, 7, 10),
                new HeightTestData(new List<uint> { 7, 6, 5, 6, 4, 3, 6, 5, 3, 6, 8 }, null, 10, 9),
            };
