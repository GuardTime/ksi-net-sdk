...
{
    [TestFixture]
    public class ExtendedSignatureAggregationChainRightLinksMatchesRuleTests : RuleTestsBase
    {
        public override VerificationRule Rule => new ExtendedSignatureAggregationChainRightLinksMatchesRule();
