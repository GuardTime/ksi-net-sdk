...
{
    [TestFixture]
    public class CalendarAuthenticationRecordPublicationTimeRuleTests : RuleTestsBase
    {
        public override VerificationRule Rule => new CalendarAuthenticationRecordPublicationTimeRule();
