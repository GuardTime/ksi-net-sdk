...
namespace Guardtime.KSI.Parser
{
    ...
    public class RawTagTest
    {
        ...
        [TestMethod]
        public void TestRawTagCreateFromData()
        {
        ...
        [TestMethod]
        public void TestRawTagProperties()
        {
            var tag = new RawTag(0x1, true, true, new byte[] { 0x1, 0x2, 0x3 });
            Assert.AreEqual((uint)0x1, tag.Type, "Tag type should be preserved");
            Assert.IsTrue(tag.NonCritical, "Tag non critical flag should be preserved");
        ...
        public void TestRawTagCreateFromNullData()
        {
        ...
        public void TestRawTagCreateFromNullTag()
        {
            var tag = new RawTag(null);
        }
    }
}
