...
namespace Guardtime.KSI.Parser
{
    ...
    public class ImprintTagTest
    {
        ...
        public void TestImprintTagCreateFromTag()
        {
            ...
            Assert.AreEqual(new ImprintTag(new RawTag(0x1, false, false, new byte[] { 0x1, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x30, 0x31, 0x32 })), tag, "Tags should be equal");
        }
