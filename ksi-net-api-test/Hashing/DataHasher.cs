...
namespace Guardtime.KSI.Hashing
{
    ...
    public class DataHasherTests
    {
        ...
        public void TestDataHasherWithDefaultAlgorithmAndEmptyData()
        {
            ...
            Assert.AreEqual(HashAlgorithm.Sha2256.Length, hasher.GetHash().Value.Length);
            Assert.AreEqual("E3-B0-C4-42-98-FC-1C-14-9A-FB-F4-C8-99-6F-B9-24-27-AE-41-E4-64-9B-93-4C-A4-95-99-1B-78-52-B8-55", BitConverter.ToString(hasher.GetHash().Value));
        }
        ...
        public void TestDataHasherWithDefaultAlgorithm()
        {
            ...
            hasher.AddData(data);
            Assert.AreEqual(HashAlgorithm.Sha2256.Length, hasher.GetHash().Value.Length);
            Assert.AreEqual("CF-00-FC-3A-72-A2-F7-1C-7D-E2-B7-18-C0-A4-DF-F3-8D-83-C0-E1-95-7E-C2-19-C3-B2-66-F8-CC-38-B9-EA", BitConverter.ToString(hasher.GetHash().Value));
        }
        ...
        public void TestDataHasherWithDefaultAlgorithmAndFileStream()
        {
            ...
            Assert.AreEqual(HashAlgorithm.Sha2256.Length, hasher.GetHash().Value.Length);
            Assert.AreEqual("54-66-E3-CB-A1-4A-84-3A-5E-93-B7-8E-3D-6A-B8-D3-49-1E-DC-AC-7E-06-43-1C-E1-A7-F4-98-28-C3-40-C3", BitConverter.ToString(hasher.GetHash().Value));
            stream.Close();
        }
        ...
        public void TestDataHasherWithRipemd160Algorithm()
        {
            ...
            Assert.AreEqual(HashAlgorithm.Ripemd160.Length, hasher.GetHash().Value.Length);
            Assert.AreEqual("9C-11-85-A5-C5-E9-FC-54-61-28-08-97-7E-E8-F5-48-B2-25-8D-31", BitConverter.ToString(hasher.GetHash().Value));
        }
