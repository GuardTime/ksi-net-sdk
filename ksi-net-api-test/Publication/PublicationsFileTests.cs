...
namespace Guardtime.KSI.Publication
{
    ...
    public class PublicationsFileTests
    {
        ...
        public void TestCreatePublicationsFileFromFile()
        {
            ...
            {
                new PublicationsFileFactory(new PkiTrustStoreProvider(TrustStore.GetTrustAnchorCollection(), new CertificateRdnSubjectSelector("E=publications@guardtime.com"))).Create(stream);
            }
        }
        ...
        public void TestFindCertificateById()
        {
            using (FileStream stream = new FileStream("resources/publication/publicationsfile/ksi-publications.bin", FileMode.Open))
            {
                IPublicationsFile publicationsFile = new PublicationsFileFactory(new PkiTrustStoreProvider(TrustStore.GetTrustAnchorCollection(), new CertificateRdnSubjectSelector("E=publications@guardtime.com"))).Create(stream);
