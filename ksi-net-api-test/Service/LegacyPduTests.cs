...
namespace Guardtime.KSI.Test.Service
{
    ...
    public class LegacyPduTests : StaticServiceTestsBase
    {
        ...
        public void LegacyPduMacCalcTest()
        {
            ...
            Assert.IsTrue(LegacyPdu.ValidateMac(bytes, mac, Util.EncodeNullTerminatedUtf8String("pass")), "MAC should be valid");
        }
        ...
        public void LegacyPduMacCalcInvalidTest()
        {
            ...
            Assert.IsFalse(LegacyPdu.ValidateMac(bytes, mac, Util.EncodeNullTerminatedUtf8String("pass")), "MAC should be invalid");
        }
        ...
        public void LegacyPduMacCalcWith0x0IntStaticInvalidTest()
        {
            ...
            Assert.IsFalse(LegacyPdu.ValidateMac(pduBytes, pdu.Mac, Util.EncodeNullTerminatedUtf8String("pass")), "MAC should be invalid");
        }
    }
}